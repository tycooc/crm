									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/linkman_initAddUI.action"
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/visit_findByPage.action" target=main>－客户拜访列表</A></TD>
												</TR>
									...
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/customer_findBySource.action" target=main>－客户来源统计</A></TD>
												</TR>
